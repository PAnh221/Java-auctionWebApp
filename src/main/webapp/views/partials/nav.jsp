...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link"
                   href="${pageContext.request.contextPath}/Product/Watchlist?UserID=${authUser.userID}">Watchlist</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/Product/MyBid?UserID=${authUser.userID}">My
                    Bid</a>
            </li>
            <div class="navbar-nav dropdown show ml-3">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <c:forEach items="${categoriesWithDetails}" var="c">
                        <a href="${pageContext.request.contextPath}/Product/ByCat?id=${c.catID}" class="dropdown-item">
                                ${c.catName}
                        </a>
                    </c:forEach>
                </div>
        ...
        <form class="form-inline" style="width: 400px;" method="get"
              action="${pageContext.request.contextPath}/Home/bySearch">
            ...
            <c:choose>
                <c:when test="${auth}">
                    <c:if test="${authUser.getPermission() == 1}">
                        <a href="${pageContext.request.contextPath}/Misc/Upload">
                            <button type="button" class="btn btn-outline-info mr-3">Post A Product</button>
                        </a>
                    </c:if>
