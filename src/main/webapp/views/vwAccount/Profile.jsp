...
<div class="d-flex flex-column justify-content-center" id="login-box">
    ...
    <div class="login-box-content">
        ...
        <div class="gp-login box-shadow"><a class="d-flex flex-row align-items-center social-login-link"
                                            style="margin-bottom:10px;" href="#"><i class="fa fa-google"
                                                                                    style="color:rgb(255,255,255);width:56px;"></i>Login
            with Google+</a></div>
    </div>
    ...
    <div class="username-login" style="background-color:#ffffff;">
        <input type="text" class="username-input form-control" style="margin-top:10px;" required="" placeholder="User name" minlength="6">
