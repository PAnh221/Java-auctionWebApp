                ...
                <div class="form" id="frmCategory" style="width: 100%">
                    <form action="" class="form_accounts" method="post" style="width: 100%">
                        ...
                        <div class="input-form">
                            ...
                            <button type="submit" class="btn btn-outline-danger" formaction="${pageContext.request.contextPath}/Admin/Category/Delete" style="padding: 5px 40px; font-size: 20px">
                                Delete
                            </button>
