...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 27, 2021 lúc 09:54 AM
...
CREATE TABLE IF NOT EXISTS `rating` (
  ...
  PRIMARY KEY (`RateID`),
  KEY `rating_Bidder` (`IdBidder`),
  KEY `rating_Seller` (`IdSeller`)
...
ALTER TABLE `watchlist`
  ADD CONSTRAINT `watchlist_ibfk_1` FOREIGN KEY (`ProID`) REFERENCES `product` (`ProID`),
